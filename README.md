...
("Add file" â†’ "Upload files" button se, ya drag-drop kar ke), including:
- `config.json`
...
kar `product_selector`, `name_selector`, `price_selector` set karenge â€” ye
...
Iske baad ye **har ghante khud chalega** â€” koi manual kaam nahi.
...
(jo simple scraping se nahi milta). Aisi surat mein mujhe URL dein â€” main check
